    ...
    public class LocalizationService : ILocalizationService
    {
        ...
        private void InitializeStrings()
        {
            ...
            _strings["es-ES"] = new Dictionary<string, string>
            {
                ...
                { "messages.reply", "\u21a9\ufe0f Responder" },
                { "messages.copy_text", "\U0001F4CB Copiar el texto" },
                ...
                { "messages.forward_rule", "\u2699\ufe0f Reenv\u00edo autom\u00e1tico" },
            ...
            _strings["en-US"] = new Dictionary<string, string>
            {
                ...
                { "messages.reply", "\u21a9\ufe0f Reply" },
                { "messages.copy_text", "\U0001F4CB Copy the text" },
                ...
                { "messages.forward_rule", "\u2699\ufe0f Auto-forward" },
